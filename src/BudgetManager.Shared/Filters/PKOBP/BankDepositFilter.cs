...
namespace BudgetManager.Shared.Filters.PKOBP
{
    public class BankDepositFilter : ITransactionFilter
    {
        ...
        public IEnumerable<TransactionResultRow> FilterTransactions(IEnumerable<TransactionResultRow> allTransactions)
        {
