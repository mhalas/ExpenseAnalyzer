...
{
    [TestFixture]
    public class TransferFromAccountTransactionTypeTests
    {
        private TransferFromAccountTransactionType _transactionType;

        [SetUp]
        public void Setup()
        {
            _transactionType = new TransferFromAccountTransactionType();
        }
        ...
        private class TestCases : IEnumerable
        {
            ...
            {
                yield return TestCase.TransferFromAccount.Case1;
                yield return TestCase.TransferFromAccount.Case2;
                yield return TestCase.TransferFromAccount.Case3;
                yield return TestCase.TransferFromAccount.Case4;
                yield return TestCase.TransferFromAccount.Case5;
                yield return TestCase.TransferFromAccount.Case6;
                yield return TestCase.TransferFromAccount.Case7;
                yield return TestCase.TransferFromAccount.Case8;
            }
        }

        [TestFixtureSource(typeof(TestCases))]
        public class WhenPassCorrectTransactionRow : TransferFromAccountTransactionTypeTests
        {
